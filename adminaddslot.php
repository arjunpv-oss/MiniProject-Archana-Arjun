...
<div class="container">
    ...
    <table class="table" style="width: 1500px">
        ...
        <tr>
            ...
            <td><button style="color: white;background-color: green"><a style="background-color: green;color: white" href="updateslot.php?op=update&slotnumber=<?php echo  $row['slot_number']?>" >UPDATE</a></button></td>
