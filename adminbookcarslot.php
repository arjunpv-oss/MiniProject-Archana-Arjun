    ...
    <div class="inner_content">
        ...
        <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="hr_book_form">
            ...
            $date = date('y-m-d');
                    ...
                    $records = mysqli_query($conn,"select * from creservation where date_res='$date'");
            ...
            $query= "SELECT time FROM workingtime where time not in(select time from creservation where date_res='$date')" ;
