...
<div class="content remove_pad" onclick="remove_class()">
    ...
    <div class="inner_content on_parallax">
        ...
        <div class="order_holder">
            ...
            <p class="summary_p">Thank you for your patronage <?php echo $name; ?>. Your <span>Order number</span> is: <?php echo $_SESSION['order_id']; ?>. We will ensure that your order is delivered in time and we do hope that you continue patronizing us. Please it is important to take note that your order number should be kept safe</p>
    ...
    <div class="inner_content">
        ...
        <div class="contact">
            ...
            <div class="left">
                ...
                <h3>CONTACT</h3>
                <p>8954334246</p>
                <p>wiltonrestaurants@gmail.com</p>
