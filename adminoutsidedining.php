...
<head>
    <meta charset="UTF-8">
    <title>Admin view outsidedining</title>
    <link rel="stylesheet">
</head>
<style>
        ...
        <div class="col-md-12">
            <div class="card mt-5">
                <div class="card-header">
                    <center> <h4> OUTSIDE DINING RESERVATIONS</h4> <button style="color: white;background-color: green"><a style="background-color: green;color: white;alignment: right" href="adminoutsidebook.php" >BOOK SLOT</a></button></td>
                    </center><br></center>
                </div>
                <div class="card-body">
                ...
                <div class="card-body">
                    <table class="table table-borderd">
                        ...
                        if(isset($_GET['from_date']) && isset($_GET['to_date']))
                        {
                            ...
                            $query = "SELECT * FROM oreservation WHERE date_res BETWEEN '$from_date' AND '$to_date' ";
